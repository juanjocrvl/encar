<div class="container">
	<form action = "/encar/index.php/usuarios/registrar_modelo" class="form-horizontal" method='post' id="usuario">
	<legend>REGISTRAR USUARIO</legend>	
		...
		<div class="form-group">
			...
			<div class="col-md-7">
				<input type="date" name='fechaNacimiento' class="form-control" placeholder="aaaa/mm/dd" value=<?php echo set_value('fechaNacimiento'); ?>>
		...
		<div class="form-group">
			...
			<div class="col-md-7">
				<input type="text" name='numero_tarjeta' class="form-control" value=<?php echo set_value('numero_tarjeta'); ?>>
				<font color="red"><?php echo form_error('numero_tarjeta'); ?></font>
			</div>
		</div>												
		<div class="form-group">
			<label class="col-md-2 col-md-offset-1" style="padding-top:8px;" >Codigo de seguridad</label>
			<div class="col-md-7">
				<input type="text" name='codigo_seguridad' class="form-control" value=<?php echo set_value('codigo_seguridad'); ?>>
				<font color="red"><?php echo form_error('codigo_seguridad'); ?></font>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-7">
				<input type="number" name='saldo' class="form-control" value=<?php echo set_value('saldo'); ?>>
				<font color="red"><?php echo form_error('saldo'); ?></font>
			</div>
		</div>
		<br><br>
