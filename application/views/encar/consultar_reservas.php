<div class="container">
	...
	<div class="row">
		<form method='post' id="filtrar" action=<?= '/encar/index.php/reservas/consultar' ?>>	
	...
	<div class="table-responsive">
		...
		if (!empty($reservas)) {
			...
			<tr>
				...
				<?php if($reserva->estado == 'Registrada'){ ?> 
					<td align="center">
						<form method='post' id="mover" action=<?= '/encar/index.php/reservas/cancelar/'.$reserva->codigo."/".$reserva->vehiculo ?>>
							<button type="submit" form="mover" class="btn btn-default">Cancelar</button>
						</form>
					</td>																																		
				<?php } ?>
			</tr>
