    <footer class="footer">
      <div class="container">
        <p class="text-muted">Copyright &#9400 2017. Todos los derechos reservados</p>
      </div>
    </footer>
    ...
    <script src="<?= base_url()?>bootstrap/docs/assets/js/ie10-viewport-bug-workaround.js"></script>
	</body>
</html>